...
const Policy = () => {
  ...
  <div className="responBx">
    ...
    <p>ReservationKart Online Limited, including all legal entities under the ReservationKart group (hereafter referred to as "ReservationKart" or "we") with an exception of ReservationKart Online Freight Services Private Limited (YOFSPLL), respects your (customers - hereafter referred as "you" or "user") privacy and values our relationship with our business partners, clients, third parties having contractual relationship with ReservationKart (hereafter referred to as "third party" or "service provider"), and any party who purchases/intend to purchase/inquire about any product(s) and/or service(s) made available by ReservationKart through any of ReservationKart's customer interface channels including Website, mobile site, mobile app & offline channels including call centers and offices (collectively referred herein as "Sales Channels"). We are committed to protecting your personally identifiable information (hereafter referred as "information" or "personal information" or "personal data" or "special category of personal data") by handling it responsibly and safeguarding it using appropriate technical and organizational measures.</p>
    ...
    <p>This Privacy Policy applies to ReservationKart.com, ReservationKart company pages, communications and services ("Services"), including off-site Services, such as our email services, customer care and support services and the "Contact us"; "Apply with ReservationKart" and "Share on" plugins on our digital properties.</p>
    ...
    <p>This Privacy Policy does not apply to any website(s), mobile sites and mobile apps of third parties, even if their websites/products are linked to our Website. User should take note that the information and privacy practices of ReservationKart's business partners, advertisers, sponsors or other sites to which we provide hyperlink(s), may be materially different from this Privacy Policy. Accordingly, it is recommended that you review the privacy statements and policies of any such third parties.</p>
    <p><b>ReservationKart for Business (Corporate):</b> In the event ReservationKart is providing services to you as part of our agreement with your employer, contractor, business partner, affiliate or any other party who is having a contractual arrangement with ReservationKart, then the terms and conditions stipulated in such contractual arrangement shall prevail over this data privacy policy. Such agreement may involve sharing personal data they control as part of that engagement. Our services may also include processing personal data under our client's control on our hosted software applications. All such processing will be governed by ReservationKart's client privacy policy.</p>
    ...
    <p>In such a scenario, ReservationKart will be acting as data processors while your respective employer, contractor, business partner, affiliate shall be acting as the data controller. It will be the obligation of the data controller to seek consent of the end customer.</p>
    ...
    <ul className="ml-4">
      ...
      <li>Postings or messages on any blogs, forums, platforms, wikis or social media applications of ReservationKart and ReservationKart's third parties</li>
    ...
    <p>b. The personal data we collect may also include 'sensitive' or 'special categories' of personal data such as details about your:</p>
    <ul className="ml-4">
